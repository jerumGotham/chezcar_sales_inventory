...
export const CAPABILITY_CATALOG = [
  ...
  { id: "sales:correction:request", module: "Sales", label: "Request sale corrections" },
  ...
  { id: "sales:void-replace", module: "Sales", label: "Void or replace sales" },
  ...
  { id: "sales:evidence:delete", module: "Sales", label: "Delete unreviewed receipt evidence" },
