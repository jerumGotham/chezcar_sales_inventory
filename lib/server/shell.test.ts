...
const expectedMenu = {
  ADMIN: [
    ...
    "Stock Transfers",
    "Reports",
    // Audit Trail left the sidebar for the header, beside the scope chip.
    "Branch Maintenance",
  ...
  ACCOUNTING_STAFF: ["Dashboard", "Customers", "Receipt Verification", "Customer Orders", "Returns & Warranty", "Reports"],
...
const expectedCapabilities = {
  ...
  BRANCH_STAFF: [
    ...
    "customer-orders:reserve",
    "customer-orders:record-payment",
    "customer-orders:release",
    "customer-orders:cancel",
    "sales:view",
    "sales:post",
    "sales:correction:request",
    "sales:verify:view",
    ...
    "backjobs:schedule",
    "backjobs:complete",
    "backjobs:parts:issue",
    "backjobs:parts:return",
    "backjobs:print",
    "customer-warranties:view",
    "customer-warranties:create",
    "customer-warranties:photos:add",
    "supplier-claims:view",
    "supplier-claims:create",
    "supplier-claims:evidence",
    "supplier-claims:print",
