...
- [x] 01-17-PLAN.md — Prove the unmounted Better Auth credential mechanism

**Wave 9** *(blocked on Wave 8 completion)*

- [x] 01-09-PLAN.md — Deliver owner-Admin user lifecycle APIs
- [x] 01-16-PLAN.md — Add capability-gated Inventory scope controls

**Wave 10** *(blocked on Wave 9 completion)*

- [x] 01-10-PLAN.md — Complete the temporary-credential prompt flow

**Wave 11** *(blocked on Wave 10 completion)*

- [x] 01-11-PLAN.md — Replace the mock User Management UI
...
|-------|----------------|--------|-----------|
| 1. Trusted Foundation and Data Onboarding | 16/17 | In Progress|  |
