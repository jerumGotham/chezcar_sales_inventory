...
--- | --- | --- | --- | --- | ---
GOAL | — | Canonical catalog/opening inventory, individual accounts, and server-enforced role/location access | 01-02–01-12 | COVERED | Tracer through final evidence gate
REQ | REQ-data-onboarding | Profile, review, canonicalize, migrate, seed, and safely reload workbook-derived data | 01-02–01-06, 01-12 | COVERED | Owner checkpoint is 01-04
...
CONTEXT | D-10 | Hide unauthorized UI and independently authorize server requests | 01-07–01-08, 01-11 | COVERED | No forbidden flash
CONTEXT | D-11 | Dedicated access-denied screen without protected data | 01-08 | COVERED | Sign-in remains for missing/inactive session
CONTEXT | D-12 | Admin All/specific; Branch fixed; Stock defaults SR | 01-07–01-08 | COVERED | Accounting Business-wide/no assignment
CONTEXT | D-13 | Exact role/location assignment matrix | 01-06–01-09, 01-11 | COVERED | DB + service + UI
CONTEXT | D-14 | Admin-only lifecycle for three non-Admin roles; no custom permissions/second Admin | 01-08–01-11 | COVERED | Primary identity unchanged
...
CONTEXT | D-18 | Improve current Chezcar style without redesign | 01-08, 01-10–01-11 | COVERED | Approved primitives/tokens preserved
