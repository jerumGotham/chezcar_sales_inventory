...
PostgreSQL is now active for Better Auth, Products, Suppliers, Personnel master data, Salesperson attribution for Direct Sales and Customer Orders, Backjob Installer assignment, Inventory, Stock Room split supplier receiving, SR-to-branch Stock Transfers, Customers, Accounting review state, Returns/Warranty, dashboards, notifications, and three focused reports. General Job Orders and advanced CRM/offline workflows remain mock/local or deferred behavior. The 2026-09-08 Reports-only scope/filter/PDF revision changes no schema or migrations: removing Movement/Low Stock report types preserves inventory records, indexes, and operational history. It was not runtime-verified.
