...
Posting also notifies the receiving location's assigned users plus owner and business-wide accounts; other branches are not told. A single-product delivery links its alert to that product's inventory balance, and a mixed delivery carries no link.
