...
export function SignInForm({ callbackUrl }: { callbackUrl: string }) {
  ...
  return (
    <Card className="w-full max-w-md border-emerald-100 dark:border-emerald-900 bg-card/95 shadow-2xl shadow-emerald-950/10">
      ...
      <CardContent>
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          {error && (
            <p className="rounded-xl bg-red-50 dark:bg-red-950/40 px-3 py-2 text-sm text-red-700 dark:text-red-300">
              {error}
            </p>
          )}
          <Button
