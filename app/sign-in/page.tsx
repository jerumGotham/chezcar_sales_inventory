...
export default async function SignInPage({
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-950 px-5 py-12">
      ...
      <div className="relative z-10 grid w-full max-w-5xl items-center gap-12 lg:grid-cols-[1.15fr_0.85fr]">
        <section className="hidden text-white lg:block">
          ...
          <h1 className="max-w-xl text-5xl font-bold leading-tight">
            Stock visibility from warehouse to branch.
          </h1>
          <p className="mt-5 max-w-lg text-lg leading-8 text-slate-300">
            Secure internal access for products, location inventory, transfers,
            sales, and reconciliation workflows.
          </p>
        </section>
